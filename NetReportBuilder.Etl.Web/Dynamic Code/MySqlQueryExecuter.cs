...
{
    public class MySqlQueryExecuter : IQueryExecuter
    {
        public QueryResponce Execute(QueryRequest queryParams)
        {
            ...
            var DymnamicQuery = CommonMethodForExecuteQuery.GenarateCSharpCodeForQueryToExecute(queryParams.ConnectionString, queryParams.Query, "mysql");
