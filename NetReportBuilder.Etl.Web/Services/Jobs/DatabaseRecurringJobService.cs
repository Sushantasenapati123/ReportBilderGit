...
{
    public class DatabaseRecurringJobService : RecurringJobService
    {
       
        public DatabaseRecurringJobService(IWebHostEnvironment webHost,IConfiguration configuration, ILogger<DatabaseRecurringJobService> logger):base(webHost,configuration,logger)
        {
